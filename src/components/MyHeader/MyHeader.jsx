...
class MyHeader extends React.Component {
    ...
    render() {
        return(
            <>
            {this.state.isSearch ? <Search onClick={this.handleCloseSearch}/> : null}
            <header id="top" className={this.state.isScrolled ? 'scrolled' : null}>
                <div className="headerTop">
                    ...
                    <div className="headerRight">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" className="bi bi-search" viewBox="0 0 16 16" onClick={this.handleSearch}>
