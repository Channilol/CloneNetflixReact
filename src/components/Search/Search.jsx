        ...
        return(
            ...
            <div className="searchPage">
                <div className="closeSearch">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="rgba(255,255,255,0.8)" class="bi bi-x-circle-fill" viewBox="0 0 16 16" onClick={this.props.onClick}>
